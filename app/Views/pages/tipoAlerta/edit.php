        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="<?= route_to('tipoAlerta_index'); ?>">Consultar</a></div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?= route_to('tipoAlerta_actualizar', $tipoAlerta['id']); ?>" method="POST">
                                    <div class="row">
                                        <div class="col-4">
                                            <label class="col-form-label">Descripción</label>
                                            <input type="text" class="form-control" name="descripcion" placeholder="Descripción" maxlength="100" value="<?= $tipoAlerta['descripcion'] ?>" required/>
                                        </div>
                                    </div>
                                    <br /><br />
                                    <div class="row">
