                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header"><h2>Editar contacto emergencia</h2></div>
                            <div class="card-body">
                                <form action="<?= route_to('ContactoEmergencia_actualizar', $contactoEmergencia['id']) ?>" method="POST">
                                    <div class="row">
                                        <div class="col-4">
                                            <label class="col-form-label">Nombre</label>
                                            <input type="text" class="form-control" name="nombre" placeholder="Nombre" maxlength="100" value="<?= $contactoEmergencia['nombre'] ?>" required/>
                                        </div>
                                        <div class="col-4">
                                            <label class="col-form-label">Número de teléfono</label>
                                            <input type="number" class="form-control" name="numero_telefono" placeholder="Número de telefono" maxlength="100" value="<?= $telefono ?>" required/>
                                        </div>
                                    </div>
                                    <br /><br />
