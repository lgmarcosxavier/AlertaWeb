        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="<?= route_to('usuariousuarios'); ?>">Consultar</a></div>
                </div>
            </div>
            <div class="section-body">
                <h2 class="section-title">Usuarios confianza de <?php echo $usuario['nombre'] . ' ' . $usuario['apellido']; ?></h2>
                <p class="section-lead">Consultar todos los usuarios de confianza.</p>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="row">
