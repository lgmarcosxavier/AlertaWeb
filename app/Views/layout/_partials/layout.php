    ...
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <form class="form-inline ml-auto" style="visibility: hidden;">
                    <ul class="navbar-nav">
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown dropdown-list-toggle" style="visibility: hidden;"><a href="#" data-toggle="dropdown" class="nav-link nav-link-lg message-toggle beep"><i class="far fa-envelope"></i></a>
                    ...
                    <li class="dropdown dropdown-list-toggle" style="visibility: hidden;"><a href="#" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg beep"><i class="far fa-bell"></i></a>
                        <div class="dropdown-menu dropdown-list dropdown-menu-right">
